...
class Admin extends CI_Controller {
    ...
    public function courses($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'list') {
            ...
            $this->load->view('backend/superadmin/course/list', $page_data);
        }
	...
	public function lecturer($param1 = '', $param2 = '', $param3 = ''){
        ...
        if ($param1 == 'assign_course') {
            $this->load->view('backend/admin/lecturer/assign_course');
        }

		if ($param1 == 'list') {
			$this->load->view('backend/admin/lecturer/list');
		}
	...
	public function dean($param1 = '', $param2 = '', $param3 = '')
	{
		...
		if ($param1 == 'assign_course') {
			$this->load->view('backend/superadmin/dean/assign_course');
		}
		if ($param1 == 'list') {
	...
	public function school_fees($param1 = "", $param2 = "")
	{
		...
		if ($param1 == 'list') {
			...
			$page_data['date_from'] = strtotime($date[0].' 00:00:00');
			$page_data['date_to']   = strtotime($date[1].' 23:59:59');
			$page_data['selected_department'] = $this->input->get('selectedDepartment');
			$page_data['selected_status'] = $this->input->get('selectedStatus');
	...
	public function export_school_fees($param1 = "", $date_from = "", $date_to = "", $selectedDepartment = "", $selected_status = "all")
	{
		//RETURN EXPORT URL
		if ($param1 == 'url') {
			$type = $this->input->post('type');
			...
			$date_from = strtotime($date[0].' 00:00:00');
			$date_to   = strtotime($date[1].' 23:59:59');
			$selected_department = $this->input->post('selectedDepartment');
			$selected_status = $this->input->post('selectedStatus');
			echo route('export_school_fees/'.$type.'/'.$date_from.'/'.$date_to.'/'.$selected_department.'/'.$selected_status);
		}
		// EXPORT AS PDF
		if ($param1 == 'pdf' || $param1 == 'print') {
			$page_data['action']   = $param1;
			$page_data['date_from'] = $date_from;
			$page_data['date_to']   = $date_to;
			$page_data['selected_department'] = $selectedDepartment;
			$page_data['selected_status'] = $selected_status;
