...
class Superadmin extends CI_Controller
{
    ...
    public function course_registration($param1 = '', $param2 = '', $param3 = '')
    {
		...
		if($param1 === "form"){
			...
			if(strtotime($semester["registration_deadline"] . "23:59") < time()){
				//Show Instruction on how to register
    ...
    public function class_room($param1 = '', $param2 = '')
    {
        ...
        // PROVIDE A LIST OF SECTION ACCORDING TO CLASS ID
        if ($param1 == 'list') {
            return $this->load->view('backend/superadmin/class_room/list');
        }

        if ($param1 == '') {
            return $this->load->view('backend/index', array());
        }
    ...
    public function subject($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'list') {
            ...
            return $this->load->view('backend/superadmin/subject/list', $page_data);
        }
    ...
    {
        if ($param1 == 'create') {
            $response = $this->crud_model->course_create();
            echo $response;
        }

        if ($param1 == 'update') {
            $response = $this->crud_model->course_update($param2);
            echo $response;
        }

        if ($param1 == 'delete') {
            $response = $this->crud_model->course_delete($param2);
            echo $response;
        }

        if ($param1 == 'list') {
            $page_data['department_id'] = $param2;
            return $this->load->view('backend/superadmin/course/list', $page_data);
        }
    ...
    public function class_wise_subject($class_id)
    {
        ...
        return $this->load->view('backend/superadmin/subject/dropdown', $page_data);
    }
    //END SUBJECT section
    ...
    public function department($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'list') {
            return $this->load->view('backend/superadmin/department/list');
        }
    ...
    public function lecturer($param1 = '', $param2 = '', $param3 = '')
    {
        if ($param1 == 'create') {
            $data = $this->input->post(NULL, TRUE);
            $response = $this->user_model->create_lecturer($data);
            echo $response;
            return;
        }

        if ($param1 == 'assign_course' && $_SERVER["REQUEST_METHOD"] === "POST") {
            $data = $this->input->post(NULL, TRUE);
            $response = $this->lecturer_model->assign_course($data);
            echo $response;
            return;
        }

        if ($param1 == 'revoke_course') {// param2 should be course_id
            $response = $this->lecturer_model->revoke_course($param2);
            echo $response;
            return;
        }
        ...
        if ($param1 == 'update') {
            $data = $this->input->post(NULL, TRUE);
            $response = $this->user_model->update_lecturer($param2, $data);
            echo $response;
            return;
        }
        if ($param1 == 'department_courses' && is_numeric($param2)) {
            $courses = $this->crud_model->get_department_courses($param2);
            $response = "<option value=''>" . get_phrase("choose") . "...</option>";
            foreach($courses as $course){
                $response .= "<option value='{$course['id']}'>{$course['code']} - {$course['title']}</option>";
            }
            echo $response;
            return;
        }
        ...
        if ($param1 == 'delete') {
            $lecturer_id = $this->db->get_where('lecturers', array('user_id' => $param2))->row('id');
            $response = $this->user_model->delete_lecturer($param2, $lecturer_id);
            echo $response;
            return;
        }
        
        if ($param1 == 'assign_course') {
            $this->load->view('backend/superadmin/lecturer/assign_course');
        }
        if ($param1 == 'list') {
            $this->load->view('backend/superadmin/lecturer/list');
        }

        if (empty($param1)) {
            $page_data['folder_name'] = 'lecturer';
            $page_data['page_title'] = 'lecturers';
            $this->load->view('backend/index', $page_data);
        }
    }
    ...
    //START Dean section
    public function dean($param1 = '', $param2 = '', $param3 = '')
    {
        if ($param1 == 'create') {
            $data = $this->input->post(NULL, TRUE);
            $response = $this->user_model->create_dean($data);
            echo $response;
            return;
        }

        if ($param1 == 'assign_department' && $_SERVER["REQUEST_METHOD"] === "POST") {
            $data = $this->input->post(NULL, TRUE);
            $response = $this->lecturer_model->assign_department($data);
            echo $response;
            return;
        }
        ...
        if ($param1 == 'update') {
            $data = $this->input->post(NULL, TRUE);
            $response = $this->user_model->update_dean($param2, $data);
            echo $response;
            return;
        }
        if ($param1 == 'department_courses' && is_numeric($param2)) {
        ...
        if ($param1 == 'delete') {
            $dean_id = $this->db->get_where('deans', array('user_id' => $param2))->row('id');
            $response = $this->user_model->delete_dean($param2, $dean_id);
            echo $response;
            return;
        }
        
        if ($param1 == 'assign_department') {
            $this->load->view('backend/superadmin/dean/assign_department');
        }
        if ($param1 == 'list') {
            $this->load->view('backend/superadmin/dean/list');
        }

        if (empty($param1)) {
            $page_data['folder_name'] = 'dean';
            $page_data['page_title'] = 'Exam Officer';
            $this->load->view('backend/index', $page_data);
        }
    }
    //END Dean section
    // start HOD SECTION
    public function hod($param1 = '', $param2 = '', $param3 = '')
    {
        if ($param1 == 'create') {
            $data = $this->input->post(NULL, TRUE);
            $response = $this->user_model->create_head_of_department($data);
            echo $response;
            return;
        }
        ...
        if ($param1 == 'update') {
            $data = $this->input->post(NULL, TRUE);
            $response = $this->user_model->update_head_of_department($param2, $data);
            echo $response;
            return;
        }
        if ($param1 == 'department_courses' && is_numeric($param2)) {
        ...
        if ($param1 == 'delete') {
            $head_of_department_id = $this->db->get_where('head_of_departments', array('user_id' => $param2))->row('id');
            $response = $this->user_model->delete_head_of_department($param2, $head_of_department_id);
            echo $response;
            return;
        }
        
        if ($param1 == 'assign_department') {
            $this->load->view('backend/superadmin/hod/assign_department');
        }
        if ($param1 == 'list') {
            $this->load->view('backend/superadmin/hod/list');
        }

        if (empty($param1)) {
            $page_data['folder_name'] = 'hod';
            $page_data['page_title'] = 'hod';
            $this->load->view('backend/index', $page_data);
        }
    }
    ...
    //START lecturer PERMISSION section
    public function permission($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'modify_permission') {
            ...
            $this->user_model->lecturer_permission();
            $this->load->view('backend/superadmin/permission/list', $page_data);
        }

        if (empty($param1)) {
            $page_data['folder_name'] = 'permission';
            $page_data['page_title'] = 'lecturer_permissions';
            $this->load->view('backend/index', $page_data);
        }
    }
    //END lecturer PERMISSION section
    ...
    public function student($param1 = '', $param2 = '', $param3 = '', $param4 = '', $param5 = '')
    {
        ...
        if ($param1 == 'filter' && $_SERVER["REQUEST_METHOD"] = "POST") {
            $data_input["data"] = $this->input->post(NULL, TRUE);
            $this->load->view('backend/superadmin/student/list', $data_input);
        }
    ...
    public function promotion($param1 = "", $promotion_data = "")
    {
    ...
    public function school_add_fees($param1 = "", $param2 = "")
    {
        // For creating new invoice
       
        // For deleting invoice
        if ($param1 == 'delete' && is_numeric($param2) ) {
            $response = $this->crud_model->delete_add_invoice($param2);
            echo $response;
        }

       
    }
    public function resit_add_fees($param1 = "", $param2 = "")
    {
        // For creating new invoice
       
        // For deleting invoice
        if ($param1 == 'delete' && is_numeric($param2) ) {
            $response = $this->crud_model->delete_add_resit($param2);
            echo $response;
        }
    ...
    public function school_fees($param1 = "", $param2 = "")
    {
        ...
        if (empty($param1)) {
            ...
            $page_data['date_from']   = strtotime($first_day_of_month);
            $page_data['date_to']     = strtotime($last_day_of_month);
            $page_data['selected_department'] = 'all';
            $page_data['selected_status'] = 'all';
            $this->load->view('backend/index', $page_data);
        }
    }
    ...
    public function export($param1 = "", $date_from = "", $date_to = "", $selected_class = "", $selected_status = "")
    {
        ...
        if ($param1 == 'csv') {
            ...
            $invoices = $this->accounting_m->get_invoice_by_date_range($date_from, $date_to, $selected_class, $selected_status)->result_array();
    ...
    //ACADEMIC YEAR CRUD & Display
    public function academic_years($param1 = "", $param2 = ""){
        if ($param1 == 'create') {
            $response = $this->settings_model->academic_year_create();
            echo $response;
        }

        if ($param1 == 'update') {
            $response = $this->settings_model->academic_year_update($param2);
            echo $response;
        }

        if ($param1 == 'delete') {
            $response = $this->settings_model->academic_year_delete($param2);
            echo $response;
        }

        if ($param1 == 'list') {
            $this->load->view('backend/superadmin/settings/variables/academic_year/list');
        }
        if (empty($param1)) {
            $page_data['folder_name'] = 'settings/variables/academic_year';
            $page_data['page_title'] = 'academic_year';
            $this->load->view('backend/index', $page_data);
        }
    }

    //Programs CRUD & Display
    public function program($param1 = "", $param2 = ""){
        if ($param1 == 'create') {
            $response = $this->crud_model->program_create();
            echo $response;
        }

        if ($param1 == 'update') {
            $response = $this->crud_model->program_update($param2);
            echo $response;
        }

        if ($param1 == 'delete') {
            $response = $this->crud_model->program_delete($param2);
            echo $response;
        }

        if ($param1 == 'list') {
            $this->load->view('backend/superadmin/settings/variables/program/list');
        }
        if (empty($param1)) {
            $page_data['folder_name'] = 'settings/variables/program';
            $page_data['page_title'] = 'programs';
            $this->load->view('backend/index', $page_data);
        }
    }

    //Relationships CRUD & Display
    public function relationship($param1 = "", $param2 = ""){
        if ($param1 == 'create') {
            $response = $this->crud_model->relationship_create();
            echo $response;
        }

        if ($param1 == 'update' && is_numeric($param2)) {
            $response = $this->crud_model->relationship_update($param2);
            echo $response;
        }

        if ($param1 == 'delete' && is_numeric($param2)) {
            $response = $this->crud_model->relationship_delete($param2);
            echo $response;
        }

        if ($param1 == 'list') {
            $this->load->view('backend/superadmin/settings/variables/relationship/list');
        }
        if (empty($param1)) {
            $page_data['folder_name'] = 'settings/variables/relationship';
            $page_data['page_title'] = 'relationships';
            $this->load->view('backend/index', $page_data);
        }
    }

    //Relationships CRUD & Display
    public function fees_currencies($param1 = "", $param2 = ""){

        if ($param1 == 'update') {
            $response = $this->settings_model->update_fee_currencies_settings($param2);
            echo $response;
        }
        // showing the Smtp Settings file
        if (empty($param1)) {
            $page_data['folder_name'] = 'settings';
            $page_data['page_title']  = 'fees_currencies_settings';
            $page_data['settings_type'] = 'fees_currencies_settings';
            $this->load->view('backend/index', $page_data);
        }
    }

    //Grading Scheme CRUD & Display
    public function grading_scheme($param1 = ""){
        if ($param1 == 'save' && $_SERVER["REQUEST_METHOD"] === "POST") {
            $data = $this->input->post(NULL, TRUE);
            $grading_schemes = $data["main"];
            $response = $this->settings_model->save_grading_scheme($grading_schemes);
            echo $response;
        }
        // showing the Smtp Settings file
        if (empty($param1)) {
            $page_data['grading_schemes'] = $this->crud_model->get_grading_schemes();
            $page_data['folder_name'] = 'settings';
            $page_data['page_title']  = 'grading_scheme';
            $page_data['settings_type'] = 'grading_scheme';
            $this->load->view('backend/index', $page_data);
        }
    }

    // Manage School Fees
    public function fees($param1 = "", $param2 = ""){
        if ($param1 == 'create') {
            $data = $this->input->post(NULL, TRUE);
            $response = $this->accounting_m->add_academic_year_fee($data);
            echo $response;
        }

        if ($param1 == 'update' && is_numeric($param2)) {
            $data = $this->input->post(NULL, TRUE);
            $response = $this->accounting_m->update_academic_year_fee($data, $param2);
            echo $response;
        }

        if ($param1 == 'delete' && is_numeric($param2)) {
            $response = $this->accounting_m->delete_academic_year_fee($param2);
            echo $response;
        }

        if ($param1 == 'list') {
            $page_data['fee_id'] = $param2;
            $this->load->view('backend/superadmin/fees/list', $page_data);
        }

        if (empty($param1)) {
            $page_data['folder_name'] = 'fees';
