...
class Email_model extends CI_Model {
	...
	function account_opening_email($account_type = '' , $email = '', $password = '')
	{
		...
		$email_msg		.=	"Login Here : ".base_url("/index.php/login")."<br />";

		$email_sub1		=	"Welcome to " . $system_name;
		$email_to		=	$email;

		if (get_smtp('mail_sender') == 'php_mailer') {
			$this->send_mail_using_php_mailer($email_msg , $email_sub1 , $email_to);
		}else{
			$this->send_mail_using_smtp($email_msg , $email_sub1 , $email_to);
		}
	}
