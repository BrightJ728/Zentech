...
?>
<form method="POST" class="d-block ajaxForm" action="<?= route('school_fees/single'); ?>">
  <div class="form-row">
    ...
    <div class="form-group col-md-12">
      ...
      <div id="student_content">
        <select readonly="readonly" name="student_id" id="student_id_on_create" class="form-control select2" data-toggle="select2" required onchange="getStudentFees(this.value)">
    ...
    <div class="form-group col-md-12">
		...
		<input type="text" readonly="readonly" value="<?= ucwords( get_phrase("school_fees_invoice") ) ?>" class="form-control" id="title" name = "title" required>
    </div>
