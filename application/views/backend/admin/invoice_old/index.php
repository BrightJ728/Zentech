    ...
    <div class="card">
      <div class="card-body">
        <h4 class="page-title">
          ...
          <button type="button" class="btn btn-outline-primary btn-rounded alignToTitle" onclick="rightModal('<?= site_url('modal/popup/invoice/single'); ?>', '<?= get_phrase('add_single_invoice'); ?>')"> <i class="mdi mdi-plus"></i> <?= get_phrase('add_single_invoice'); ?></button>
          <button type="button" class="btn btn-outline-success btn-rounded alignToTitle" style="margin-right: 10px;" onclick="rightModal('<?= site_url('modal/popup/invoice/mass'); ?>', '<?= get_phrase('add_mass_invoice'); ?>')"> <i class="mdi mdi-plus"></i> <?= get_phrase('add_mass_invoice'); ?></button>
        </h4>
      </div> <!-- end card body-->
    </div> <!-- end card -->
  </div><!-- end col-->
          ...
          <div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 mb-3 mb-lg-0">
            <div class="form-group">
              <select name="class" id="class_id" class="form-control select2" data-toggle="select2">
                <option value="all"><?= get_phrase('all_class'); ?></option>
                <?php
