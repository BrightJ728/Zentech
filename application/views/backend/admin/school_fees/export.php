<?php
	...
	if ($selected_department == 'all') {
		...
		$department = $departments = $this->departments_model->get($invoice["department_id"]); 
		$classNameForTitle = $department['name'];
	}
...
<body>
	...
	<table width="100%">
		...
		<tbody>
			<?php 
				$invoices = $this->accounting_m->get_invoice_by_date_range($date_from, $date_to, $selected_department, $selected_status);
