<table id="basic-datatable" class="table table-striped dt-responsive nowrap" width="100%">
    ...
    <tbody>
        <?php $invoices = $this->accounting_m->get_invoice_by_date_range($date_from, $date_to, $selected_department, $selected_status);
            ...
            <tr>
                ...
                <td>
                    <?= currency($invoice['total_amount'] - $invoice['paid_amount']); ?> <br>
                </td>
                <td>
                ...
                <td>
                    <div class="dropdown text-center">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <?php endif ?>
                            <a href="javascript:void(0);" class="dropdown-item" onclick="rightModal('<?= site_url('modal/popup/school_fees/edit/'.$invoice['id']); ?>', '<?= get_phrase('update_invoice'); ?>');"><?= get_phrase('edit'); ?></a>
                            <!-- item-->
