    ...
    <div class="card">
      <div class="card-body">
        <h4 class="page-title">
          ...
          <button type="button" class="btn btn-outline-primary btn-rounded alignToTitle" onclick="rightModal('<?= site_url('modal/popup/subject/create'); ?>', '<?= get_phrase('create_subject'); ?>')"> <i class="mdi mdi-plus"></i> <?= get_phrase('add_subject'); ?></button>
        </h4>
      </div> <!-- end card body-->
    </div> <!-- end card -->
  </div><!-- end col-->
