              ...
              <p class="font-13"><strong><?= get_phrase('status'); ?>: </strong>
                <?php if (strtolower($invoice_details['status']) == 'paid'): ?>
                  <span class="badge badge-success float-right"><?= get_phrase('paid'); ?></span></p>
                   <?php if (strtolower($invoice_details['status']) == 'Partial payment'): ?>
                  <span class="badge badge-warning-lighten float-right"><?= get_phrase('partial_payment'); ?></span></p>
                <?php else: ?>
                ...
                <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><?= currency($invoice_details['paid_amount']); ?></td>
