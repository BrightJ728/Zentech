<?php
  $invoice_details = $this->accounting_m->get_resit_fees_invoice($resit_fees_invoice_id);
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
						...
						<?php $resit_fees_invoice_payments = $this->accounting_m->get_resit_fees_payments($invoice_details["id"]); 
