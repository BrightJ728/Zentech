            ...
            <td>
              ...
              <div class="dropdown text-center">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  <!-- item-->
                  <a href="javascript:void(0);" class="dropdown-item" onclick="rightModal('<?= site_url('modal/popup/settings/academic_year/edit/'.$academic_year['id']. '?view=variables/academic_year/edit&param1=' . $academic_year['id'])?>', '<?= get_phrase('update_academic_year'); ?>');"><?= get_phrase('edit'); ?></a>
                  <!-- item-->
