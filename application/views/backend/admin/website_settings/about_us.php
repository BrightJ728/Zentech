    ...
    <form method="POST" class="col-12 aboutUsSettings" action="<?= route('about_us/update') ;?>" id = "about_us_settings">
      <div class="row justify-content-left">
        <div class="col-12">
          ...
          <div class="form-group row mb-3">
            <label class="col-md-3 col-form-label" for="example-fileinput"><?= get_phrase('about_us_banner'); ?></label>
            <div class="col-md-9 custom-file-upload">
              <div class="wrapper-image-preview" style="margin-left: -6px;">
                <div class="box" style="width: 250px;">
                  <div class="js--image-preview" style="background-image: url(<?= $this->frontend_model->get_about_image(); ?>); background-color: #F5F5F5;"></div>
                  <div class="upload-options">
                    <label for="about_us_image" class="btn"> <i class="mdi mdi-camera"></i> <?= get_phrase('upload_about_us_image'); ?> </label>
