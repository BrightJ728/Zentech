...
<form method="POST" class="d-block ajaxForm" action="<?= route('events/update/'.$param1); ?>">
  <div class="form-row">
    ...
    <div class="form-group col-md-12">
      ...
      <input type="text" value="<?= date('m/d/Y', $event['timestamp']); ?>" class="form-control" id="timestamp" name = "timestamp" data-provide = "datepicker" required>
