    ...
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title">
                ...
                <!-- <a class="btn btn-primary btn-rounded pull-right" href="<?= route('transcript/pdf') ?>"> <i class="mdi mdi-download"></i> <?= get_phrase('print_transcript'); ?></a> -->
                 	</h4>
        </div>
    </div>
</div>
...
<script>
    var showAllTranscript = function () {
        ...
        initDataTableVettingStudent('datatable-buttons1');
        $.ajax({
