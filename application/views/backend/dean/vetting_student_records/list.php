                    ...
                    <?php foreach($student_records as $student_record): ?>
                        <?php if($student_record["status"] === "pending"){ ?>
                            <tr>
                                ...
                                <td><input type="number" min="0" max="30" value="<?= $student_record["class_score"] ?? '' ?>" onkeyup="calcTotal(<?=$student_record['id']?>)" class="form-control" name="class_mark-<?=$student_record['id']?>" id="class_mark-<?=$student_record['id']?>" placeholder="class mark"/></td>
                                <td><input type="number" min="0" max="70" value="<?= $student_record["exam_score"] ?? '' ?>" onkeyup="calcTotal(<?=$student_record['id']?>)" class="form-control" name="exam_mark-<?=$student_record['id']?>" id="exam_mark-<?=$student_record['id']?>" placeholder="exam mark"/></td>
