...
<div class="row d-print-none">
  <div class="col-xl-12">
    <div class="card">
      <div class="card-body">
        <h4 class="page-title">
          <i class="mdi mdi-calendar-today title_icon"></i> <?= get_phrase('daily_attendance'); ?>
          <button type="button" class="btn btn-outline-primary btn-rounded alignToTitle" onclick="rightModal('<?= site_url('modal/popup/attendance/take_attendance'); ?>', '<?= get_phrase('take_attendance'); ?>')"> <i class="mdi mdi-plus"></i> <?= get_phrase('take_attendance'); ?></button>
          <?php if (addon_status('biometric-attendance')): ?>
            <button type="button" class="btn btn-outline-info btn-rounded alignToTitle mr-1" onclick="rightModal('<?= site_url('modal/popup/attendance/biometric_attendance'); ?>', '<?= get_phrase('import_biometric_attendance'); ?>')"> <i class="mdi mdi-plus"></i> <?= get_phrase('biometric_attendance'); ?></button>
          <?php endif; ?>
        </h4>
      </div> <!-- end card body-->
    </div> <!-- end card -->
