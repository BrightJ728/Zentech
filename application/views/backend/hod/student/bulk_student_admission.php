...
<form method="POST" class="col-md-12 ajaxForm" action="<?= route('student/create_bulk_student'); ?>" id = "student_admission_form">
    ...
    <div class="text-center">
        <button type="submit" class="btn btn-secondary col-md-4 col-sm-12 mb-4 mt-2"><?= get_phrase('add_students'); ?></button>
    </div>
</form>
