    ...
    <div class="row align-items-center h-100">
        ...
        <div class="col-md-8">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false"><?= get_phrase('profile'); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="parent-tab" data-toggle="tab" href="#parent_info" role="tab" aria-controls="parent_info" aria-selected="false"><?= get_phrase('parent_info'); ?></a>
                </li>
            </ul>
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <table class="table table-centered mb-0">
                        <tbody>
                            ...
                            <tr>
                                <td style="font-weight: bold;"><?= get_phrase('class'); ?>:</td>
                                <td>
                                    <?php
                            ...
                            <tr>
                                <td style="font-weight: bold;"><?= get_phrase('section'); ?>:</td>
                                <td>
                                    <?php
                ...
                <div class="tab-pane fade show" id="parent_info" role="tabpanel" aria-labelledby="parent-tab">
                    <table class="table table-centered mb-0">
                        <tbody>
                            <tr>
                                <td style="font-weight: bold;"><?= get_phrase('parent_name'); ?>:</td>
                                <td>
                                    <?= $this->user_model->get_user_details($parent['user_id'], 'name'); ?>
                                </td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?= get_phrase('parent_email'); ?>:</td>
                                <td>
                                    <?= $this->user_model->get_user_details($parent['user_id'], 'email'); ?>
                                </td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?= get_phrase('parent_phone_number'); ?>:</td>
                                <td>
                                    <?= $this->user_model->get_user_details($parent['user_id'], 'phone'); ?>sddfas
                                </td>
                            </tr>
                        </tbody>
                    </table>
