...
<script src="<?= base_url(); ?>assets/backend/js/vendor/buttons.bootstrap4.min.js"></script>
...
<script src="<?= base_url(); ?>assets/backend/js/vendor/jquery-ui.min.js"></script>
<script src="<?= base_url(); ?>assets/backend/js/vendor/fullcalendar.min.js"></script>
...
<script src="<?= base_url("assets/backend/js/jquery.steps.js") ?>"></script>
...
<!--Custom JS-->
<script src="<?= base_url(); ?>assets/backend/js/ajax_form_submission.js"></script>
<script src="<?= base_url(); ?>assets/backend/js/custom.js"></script>
<script src="<?= base_url(); ?>assets/backend/js/content-placeholder.js"></script>
<script src="<?= base_url(); ?>assets/backend/js/addon.js"></script>
<script src="<?= base_url(); ?>assets/backend/js/init.js"></script>

<!-- dragula js-->
<script src="<?= base_url(); ?>assets/backend/js/vendor/dragula.min.js"></script>
<!-- component js -->
<script src="<?= base_url(); ?>assets/backend/js/ui/component.dragula.js"></script>

<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.repeater/1.2.1/jquery.repeater.min.js"></script>

<!-- Sweet Alert -->
<script src="<?= base_url("node_modules/sweetalert2/dist/sweetalert2.all.min.js") ?>"></script>
<script type="module" src="https://cdn.jsdelivr.net/npm/promise-polyfill"></script>
<script>
	function error_required_field() {
	  $.NotificationApp.send("<?= get_phrase('oh_snap'); ?>!", "<?= get_phrase('please_fill_all_the_required_fields'); ?>" ,"top-right","rgba(0,0,0,0.2)","error");
	}
</script>