...
<div class="modal-dialog modal-sm">
	...
	<div class="modal-body p-4">
		...
		<h4 class="mt-2"><?= get_phrase('heads_up') ?>!</h4>
		<p class="mt-3"><?= get_phrase('are_you_sure'); ?>?</p>
		<form method="POST" class="ajaxDeleteForm" action="" id = "delete_form">
			<button type="button" class="btn btn-info my-2" data-dismiss="modal"><?= get_phrase('cancel'); ?></button>
			<button type="submit" class="btn btn-danger my-2" onclick=""><?= get_phrase('continue'); ?></button>
		</form>
		</div>
	</div>
	</div><!-- /.modal-content -->
...
<div class="modal-dialog modal-sm">
	...
	<div class="modal-body p-4">
		...
		<p class="mt-3"><?= get_phrase('are_you_sure'); ?>?</p>
		<button type="button" class="btn btn-info my-2" data-dismiss="modal"><?= get_phrase('cancel'); ?></button>
		<button type="submit" class="btn btn-danger my-2" onclick="callTheCallBackFunction()"><?= get_phrase('continue'); ?></button>
		</div>
	</div>
	</div><!-- /.modal-content -->
</div><!-- /.modal-dialog -->
...
<script>
async function showAjaxModal(url, header, callback)
{
		// SHOWING AJAX PRELOADER IMAGE
		jQuery('#scrollable-modal .modal-body').html('<div style="text-align:center;margin-top:200px;"><img style="width: 100px; opacity: 0.4; " src="<?= base_url().'assets/backend/images/straight-loader.gif'; ?>" /></div>');
...
<div class="modal-dialog modal-dialog-scrollable" role="document">
	<div class="modal-content">
		...
		<div class="modal-footer">
			<button class="btn btn-secondary" data-dismiss="modal"><?= get_phrase("close"); ?></button>
		</div>
	</div><!-- /.modal-content -->
</div><!-- /.modal-dialog -->
</div>