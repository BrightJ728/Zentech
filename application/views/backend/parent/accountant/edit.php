...
?>
    <form method="POST" class="d-block ajaxForm" action="<?= route('accountant/update/'.$param1); ?>">
        <div class="form-row">
            ...
            <div class="form-group  col-md-12">
                <button class="btn btn-block btn-primary" type="submit"><?= get_phrase('update_accountant'); ?></button>
            </div>
        </div>
    </form>
<?php } ?>
