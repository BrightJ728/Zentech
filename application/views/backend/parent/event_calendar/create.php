<form method="POST" class="d-block ajaxForm" action="<?= route('event_calendar/create'); ?>">
  <div class="form-row">
    ...
    <div class="form-group col-md-12">
      ...
      <input type="text" value="<?= date('m/d/Y'); ?>" class="form-control" id="starting_date" name = "starting_date" data-provide = "datepicker" required>
      <small id="name_help" class="form-text text-muted"><?= get_phrase('provide_starting_date'); ?></small>
    </div>

    <div class="form-group col-md-12">
      <label for="starting_date"><?= get_phrase('event_ending_date'); ?></label>
      <input type="text" value="<?= date('m/d/Y'); ?>" class="form-control" id="ending_date" name = "ending_date" data-provide = "datepicker" required>
