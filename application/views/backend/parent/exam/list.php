	...
	<tr>
        ...
        <div class="dropdown text-center">
					...
					<div class="dropdown-menu dropdown-menu-right">
						<!-- item-->
						<a href="javascript:void(0);" class="dropdown-item" onclick="rightModal('<?= site_url('modal/popup/exam/edit/'.$exam['id'])?>', '<?= get_phrase('update_exam'); ?>');"><?= get_phrase('edit'); ?></a>
						<!-- item-->
						<a href="javascript:void(0);" class="dropdown-item" onclick="confirmModal('<?= route('exam/delete/'.$exam['id']); ?>', showAllExams)"><?= get_phrase('delete'); ?></a>
					</div>
				</div>
	    </td>
	</tr>
