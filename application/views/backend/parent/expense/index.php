...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title"> <i class="mdi mdi-database title_icon"></i> <?= get_phrase('expense'); ?>
                <button type="button" class="btn btn-icon btn-success btn-rounded alignToTitle" onclick="rightModal('<?= site_url('modal/popup/expense/create'); ?>', '<?= get_phrase('add_new_expense'); ?>')"> <i class="mdi mdi-plus"></i> <?= get_phrase('add_new_expense'); ?></button>
            </div>
        </div>
    </div>
    <!-- end page title -->
