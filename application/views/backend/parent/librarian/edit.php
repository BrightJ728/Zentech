...
?>
    <form method="POST" class="d-block ajaxForm" action="<?= route('librarian/update/'.$param1); ?>">
        <div class="form-row">
            ...
            <div class="form-group  col-md-12">
                <button class="btn btn-block btn-primary" type="submit"><?= get_phrase('update_librarian'); ?></button>
            </div>
        </div>
    </form>
<?php } ?>
