    ...
    <div class="col-xl-10 col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" class="col-12 profileAjaxForm" action="<?= route('profile/update_profile') ; ?>" id = "profileAjaxForm" enctype="multipart/form-data">
                    <div class="col-12">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="email" id="email" name="email" class="form-control"  value="<?= $profile_data['email']; ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="phone" name="phone" class="form-control"  value="<?= $profile_data['phone']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" id="address" name = "address" rows="5"><?= $profile_data['address']; ?></textarea>
                            </div>
                        </div>
                                ...
                                <div class="wrapper-image-preview" style="margin-left: -6px;">
                                    <div class="box" style="width: 250px;">
                                        ...
                                        <div class="upload-options">
                                            <label for="profile_image" class="btn"> <i class="mdi mdi-camera"></i> <?= get_phrase('upload_an_image'); ?> </label>
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-secondary col-xl-4 col-lg-4 col-md-12 col-sm-12" onclick="updateProfileInfo()"><?= get_phrase('update_profile') ; ?></button>
                        </div>
                    </div>
                </form>
