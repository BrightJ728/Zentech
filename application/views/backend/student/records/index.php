...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title">
            	<i class="mdi mdi-content-paste title_icon"></i> <?= get_phrase('records'); ?>
                 <!-- <a class="btn btn-primary btn-rounded pull-right" href="<?= route('records/pdf') ?>"> <i class="mdi mdi-download"></i> <?= get_phrase('print_records'); ?></a>  -->
        	</h4>
        </div>
    </div>
</div>
