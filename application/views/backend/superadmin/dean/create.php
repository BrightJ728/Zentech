<form method="POST" class="d-block ajaxForm" action="<?= route('dean/create/'); ?>" enctype="multipart/form-data">
    <div class="form-row">
        ...
        <div class="form-group col-md-12">
            ...
            <small id="" class="form-text text-muted"><?= get_phrase('provide_exam_officer_address'); ?></small>
        </div>
        ...
        <div class="form-group col-md-12">
          ...
          <small id="" class="form-text text-muted"><?= get_phrase('show_this_exam_officer_on_website'); ?></small>
        </div>
        ...
        <div class="form-group mt-2 col-md-12">
            <button class="btn btn-block btn-primary" type="submit"><?= get_phrase('create_exam_officer'); ?></button>
        </div>
    </div>
</form>
