...
<?php foreach($exams as $exam){ ?>
  <form method="POST" class="d-block ajaxForm" action="<?= route('exam/update/'.$param1); ?>">
    <div class="form-row">
      <div class="form-group col-md-12">
        <label for="exam_name"><?= get_phrase('exam_name'); ?></label>
        <input type="text" value="<?= $exam['name']; ?>" class="form-control" id="exam_name" name = "exam_name" placeholder="name" required>
      ...
      <div class="form-group col-md-12">
        ...
        <input type="text" value="<?= date('m/d/Y', $exam['starting_date']); ?>" class="form-control date" id="starting_date" data-toggle="date-picker" data-single-date-picker="true" name = "starting_date" required>
      ...
      <div class="form-group col-md-12">
        ...
        <input type="text" value="<?= date('m/d/Y', $exam['ending_date']); ?>" class="form-control date" id="ending_date" data-toggle="date-picker" data-single-date-picker="true" name = "ending_date" required>
