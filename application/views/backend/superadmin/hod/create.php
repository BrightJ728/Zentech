<form method="POST" class="d-block ajaxForm" action="<?= route('hod/create/'); ?>" enctype="multipart/form-data">
    <div class="form-row">
        <div class="form-group col-md-12">
            <input type="hidden" name="school_id" value="<?= school_id(); ?>">
            <label for="name"><?= get_phrase('name'); ?></label>
            <input type="text" class="form-control" id="name" name = "name" required>
            <small id="" class="form-text text-muted"><?= get_phrase('provide_head_of_department_name'); ?></small>
        </div>

        <div class="form-group col-md-12">
            <label for="email"><?= get_phrase('email'); ?></label>
            <input type="email" class="form-control" id="email" name = "email" required>
            <small id="" class="form-text text-muted"><?= get_phrase('provide_head_of_department_email'); ?></small>
        </div>
        ...
        <div class="form-group col-md-12">
            ...
            <small id="" class="form-text text-muted"><?= get_phrase('provide_head_of_department_phone_number'); ?></small>
        </div>
        ...
        <div class="form-group col-md-12">
            ...
            <small id="" class="form-text text-muted"><?= get_phrase('provide_head_of_department_gender'); ?></small>
        </div>
        ...
        <div class="form-group mt-2 col-md-12">
            <button class="btn btn-block btn-primary" type="submit"><?= get_phrase('create_head_of_department'); ?></button>
        </div>
    </div>
</form>
