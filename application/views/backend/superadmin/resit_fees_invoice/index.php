...
<div class="row ">
  <div class="col-xl-12">
    <div class="card">
      <div class="card-body">
        <h4 class="page-title">
          <i class="mdi mdi-file-document-box title_icon"></i> <?= get_phrase('student_resit_fee_manager'); ?>
          <button type="button" class="btn btn-outline-primary btn-rounded alignToTitle" onclick="rightModal('<?= site_url('modal/popup/resit_fees_invoice/single'); ?>', '<?= get_phrase('add_resit_fees_invoice'); ?>')"> <i class="mdi mdi-plus"></i> <?= get_phrase('add_resit_fees_invoice'); ?></button>
      ...
      <div class="card-body">
        <div class="row justify-content-md-center" style="margin-bottom: 10px;">
          ...
          <div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 mb-3 mb-lg-0">
            <div class="form-group">
              <select name="program_id" id="program_id" class="form-control select2" data-toggle="select2">
				<option value="all"><?= get_phrase('all_programs'); ?></option>
				<?php
        ...
        <div class="table-responsive-sm">
          <div class="resit_fees_invoice_content">
...
var showAllInvoices = function () {
	let url = '<?= route('resit_fees_invoice/list'); ?>';
	...
	$.ajax({
		type : 'GET',
		url: url,
		data : {date : dateRange, selectedProgram : selectedProgram, selectedStatus : selectedStatus},
		success : function(response) {
		$('.resit_fees_invoice_content').html(response);
...
function getExportUrl(type) {
	...
	$.ajax({
		type : 'post',
		url: url,
		data : {type : type, dateRange : dateRange, selectedProgram : selectedProgram, selectedStatus : selectedStatus},
		success : function(response) {
		if (type == 'csv') {
