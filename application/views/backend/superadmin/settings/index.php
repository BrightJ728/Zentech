<?php
	if ($settings_type == 'system_settings')
		...
		$class = 'col-xl-10 offset-xl-1';
	else if ($settings_type == 'fees_currencies_settings')
		$class = 'col-xl-10 offset-xl-1';
	else if ($settings_type == 'school_settings')
		$class = 'col-xl-10 offset-xl-1';
	else if ($settings_type == 'sms_settings')
		$class = 'col-xl-10 offset-xl-1';
	else if ($settings_type == 'grading_scheme')
		$class = 'col-xl-12 col-xs-12';
...
<div class="row ">
	<div class="col-xl-12">
		<div class="card">
			<div class="card-body">
				<h4 class="page-title">
					<i class="mdi mdi-settings title_icon"></i><?= ucfirst(get_phrase($settings_type)); ?>
				</h4>
			</div> <!-- end card body-->
		</div> <!-- end card -->
	</div><!-- end col-->
...
<script>
	...
	function updateFeeCurrencies() {
		$(".feeCurrenciesForm").validate({});
		$(".feeCurrenciesForm").submit(function(e) {
			var form = $(this);
			ajaxSubmit(e, form, reload);
		});
	}
