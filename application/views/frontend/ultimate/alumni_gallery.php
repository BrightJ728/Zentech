    ...
    <div class="container text-center space-top-4 space-top-md-4 space-top-lg-3 space-bottom-1">
      ...
      <div class="w-md-80 w-lg-50 mx-auto mb-5">
        <h1 class="h1 text-white">
          <span class="font-weight-semi-bold"><?= get_phrase('Alumni Photo Gallery'); ?></span>
        </h1>
      </div>
      <!-- End Title -->
    </div>
  ...
  <div class="bg-light">
    <div class="container space-2 space-md-2">
      ...
      <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-9">
        <span class="btn btn-xs btn-soft-success btn-pill mb-2"><?= get_phrase('Alumni Albums'); ?></span>
        <h2 class="text-primary"><?= get_phrase('Our latest photo galleries'); ?></h2>
      </div>
      <!-- End Title -->
      ...
      <div class="row mx-gutters-2">
        ...
        <div class="col-md-4 mb-3">
          <a class="d-flex align-items-end bg-img-hero gradient-overlay-half-dark-v1 transition-3d-hover height-450 rounded-pseudo" href="<?= site_url('home/alumni_gallery_view/'.$row['id']);?>"
          style="background-image: url(<?= $this->alumni_model->get_gallery_image($cover_image); ?>);">
            <article class="w-100 text-center p-6">
              ...
              <div class="mt-4" style="margin-top:0px !important;">
                <strong class="d-block text-white-70 mb-2">
                  <?= $number_of_image;?> <?= get_phrase('images'); ?>
                </strong>
              </div>
            </article>
          </a>
