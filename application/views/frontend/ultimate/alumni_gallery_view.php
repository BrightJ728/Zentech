...
<main id="content" role="main">
    ...
    <div class="container text-center space-top-4 space-top-md-4 space-top-lg-3 space-bottom-1">
      ...
      <div class="w-md-80 w-lg-50 mx-auto mb-5">
        <h1 class="h1 text-white">
          <span class="font-weight-semi-bold"><?= get_phrase('Alumni Gallery'); ?></span>
        </h1>
      </div>
      <!-- End Title -->
    </div>
  ...
  <div class="container space-2 space-md-2">
      ...
      <p class="font-size-1"><?= $gallery_info['description']; ?></p>
        ...
        <div class="cbp-item rounded abstract">
          <div class="cbp-caption">
            <a class="cbp-lightbox u-media-viewer"
              href="<?= $this->alumni_model->get_gallery_image($image['photo']); ?>"
              data-title="<?= $gallery_info['title']; ?>">
              <img src="<?= $this->alumni_model->get_gallery_image($image['photo']); ?>"
              alt="<?= $gallery_info['title']; ?>">
