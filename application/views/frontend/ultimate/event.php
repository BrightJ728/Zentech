    ...
    <div class="container text-center space-top-4 space-top-md-4 space-top-lg-3 space-bottom-1">
      ...
      <div class="w-md-80 w-lg-50 mx-auto mb-5">
        <h1 class="h1 text-white">
          <span class="font-weight-semi-bold"><?= get_phrase('School Events'); ?></span>
        </h1>
      </div>
      <!-- End Title -->
    </div>
  ...
  <div class="bg-light">
    <div class="container space-2 space-md-2">
      ...
      <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-9">
        ...
        <h2 class="text-primary"><?= get_phrase('Upcoming and past events'); ?></h2>
      </div>
      <!-- End Title -->
      ...
      <div class="js-slick-carousel u-slick u-slick--equal-height u-slick--gutters-2"
        ...
        foreach ($events as $row) { ?>
          ...
          <div class="js-slide card border-0 mb-3" style="background-image: url(<?= $this->frontend_model->get_event_image($row['image']); ?>);"></div>
              ...
              <div class="media align-items-center">
                <div class="u-sm-avatar mr-3">
                  <img class="img-fluid rounded-circle"
                    src="<?= $this->user_model->get_user_image($created_by['id']); ?>" alt="Image Description">
                </div>
                <div class="media-body">
                  <h4 class="small mb-0"><a href="#"><?= ucfirst($created_by['name']); ?></a></h4>
                </div>
              </div>
            </div>
            <!-- End Blog Grid -->
