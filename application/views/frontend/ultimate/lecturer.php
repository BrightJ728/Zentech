    ...
    <div class="container text-center space-top-4 space-top-md-4 space-top-lg-3 space-bottom-1">
      ...
      <div class="w-md-80 w-lg-50 mx-auto mb-5">
        <h1 class="h1 text-white">
          <span class="font-weight-semi-bold">Our lecturers</span>
        </h1>
      </div>
      <!-- End Title -->
    </div>
      ...
      <!-- End Title -->
        ...
        <div class="row">
          ...
          foreach ($lecturers as $row) {
            ...
            if ($lecturer['show_on_website'] != 1) {
              continue;
            }
            $social = $lecturer['social_links'];
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-5">
                      <img class="img-fluid rounded mx-auto"
                        ...
                        alt="<?= $row['name']; ?>" style="border-radius: 100px !important;">
                    </div>
                  </div>
                  <!-- End Team -->
                </div>
