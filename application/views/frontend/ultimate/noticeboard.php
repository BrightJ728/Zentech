  ...
  <div class="bg-light">
    <div class="container space-2 space-md-2">
      ...
      <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-9">
        <span class="btn btn-xs btn-soft-success btn-pill mb-2"><?= get_phrase('Notices'); ?></span>
        <h2 class="text-primary"><?= get_phrase('Follow up school notices'); ?></h2>
      </div>
      <!-- End Title -->
              ...
              <article class="card border-0">
                <div class="card-body p-0">
                  <div class="row align-items-stretch no-gutters">
                    <div class="col-md-6 bg-img-hero min-height-300 rounded" style="background-image: url(<?= $this->crud_model->get_noticeboard_image($row['image']); ?>);"></div>
                    <div class="col-md-6">
                      <div class="p-5">
                        <!-- Post Info -->
                        ...
                        <div class="mb-4">
                          <h2 class="h5 mb-3">
                            <a href="<?= site_url('home/notice_details/'.$row['id']);?>">
                              <?= $row['notice_title'];?>
                            </a>
                          </h2>
                          <p><?= substr($row['notice'], 0, 100); ?></p>
                        </div>
                        <!-- End Info -->
                        ...
                        <ul class="list-inline mb-0">
                          <li class="list-inline-item g-mb-10">
                            <a class="btn btn-xs btn-soft-primary"
                              href="<?= site_url('home/notice_details/'.$row['id']);?>">
                              Read more</a>
                          </li>
                        </ul>
                        <!-- End Labels -->
