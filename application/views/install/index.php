...
<head>
	...
	<link rel="shortcut icon" href="<?= base_url('uploads/system/logo/favicon.png'); ?>">
	<title>Installation | Zentech</title>
	...
	<header class="navbar navbar-fixed-top" style="min-height: 80px; background: linear-gradient(135deg,#0F2027 0,#2C5364 60%) !important;">
		<div class="navbar-inner">
			...
			<div class="navbar-brand">
				<a href="#">
					<img src="<?= base_url('uploads/system/logo/logo-light.png');?>"  style="max-height:40px;"/>
				</a>
			</div>
