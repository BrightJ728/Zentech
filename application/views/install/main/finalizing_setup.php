            ...
            <div class="row">
              <div class="col-md-12">
                <form class="form-horizontal form-groups" method="post"
                  action="<?= site_url('install/finalizing_setup/setup_admin');?>">
                  <hr>
                  ...
                  <div class="form-group">
            				...
            				<div class="col-sm-5">
            					<input type="text" class="form-control" name="system_name" placeholder="Zentech School Manager"
                        required autofocus>
            				</div>
                    <div class="col-sm-4" style="font-size: 12px;">
                  ...
                  <div class="form-group">
                      ...
                      <select class="form-control select2" data-toggle="select2" id="timezone" name="timezone">
                        ...
                        <?php foreach ($tzlist as $tz): ?>
                          <option value="<?= $tz ;?>" <?php if($tz == 'Asia/Dhaka') echo 'selected'; ?>><?= $tz ;?></option>
                        <?php endforeach; ?>
                      </select>
            				</div>
                    <div class="col-sm-4" style="font-size: 12px;">
