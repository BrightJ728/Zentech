...
CREATE TABLE `menus` (
  ...
  `lecturer_access` int(11) NOT NULL DEFAULT '0',
...
(4, 'lecturer', 'lecturer', 1, NULL, 1, 1, 1, 1, 1, 1, 0, 0, 30, 0, 'lecturer'),
...
(46, 'lecturer_permission', 'permission', 1, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 40, 0, 'lecturer-permission'),
...
(1, 1, 'Zentech School Management System', 'Zentech School', 'Zentech@example.com', '+8801234567890', '4333 Factoria Blvd SE, Bellevue, WA 98006', '1234', 'USD', 'left', '1', 'english', NULL, 'By Creativeitem', 'http://creativeitem.com/', '7.1', '1234567890', '1577017315', 'Asia/Dhaka', NULL, NULL);
...
--
-- Indexes for table `lecturer_permissions`
--
ALTER TABLE `lecturer_permissions`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `lecturer_permissions`
--
ALTER TABLE `lecturer_permissions`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
